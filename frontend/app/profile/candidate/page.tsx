...
export default function CandidateProfilePage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-6 py-12 text-slate-900">
      ...
      <div className="absolute right-10 top-16 -z-10 h-44 w-44 rounded-full bg-[#5784BA] opacity-15 blur-[90px]" />
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="space-y-3">
            ...
            <h1 className="text-4xl font-semibold leading-tight sm:text-5xl">Candidate profile</h1>
