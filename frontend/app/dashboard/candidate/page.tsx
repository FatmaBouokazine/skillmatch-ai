    ...
    <div className="flex flex-col gap-10">
      <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="space-y-6">
          ...
          <h1 className="max-w-2xl text-4xl font-semibold leading-tight sm:text-5xl">Candidate dashboard</h1>
          <p className="max-w-xl text-base text-slate-600 sm:text-lg">
            Track matches, applications, and profile strength.
          </p>
          <div className="flex flex-wrap gap-3">
            <Link href="/dashboard" className="rounded-md bg-[#76cdcd] px-4 py-2 text-sm font-semibold text-slate-900 hover:bg-[#63bcbc]">
              Back to overview
            </Link>
            <Link href="/profile/candidate" className="rounded-md border border-[#b9e7e7] bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-[#eefcfc]">
              View profile
            </Link>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Match score</p>
              <p className="mt-2 text-sm text-slate-600">See fit for target roles.</p>
            </div>
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Applications</p>
              <p className="mt-2 text-sm text-slate-600">Follow each step.</p>
            </div>
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Profile tips</p>
              <p className="mt-2 text-sm text-slate-600">Improve visibility.</p>
            </div>
          </div>
        </div>
        <div className="rounded-2xl border border-[#b9e7e7] bg-white p-8 shadow-sm">
          <div className="space-y-4">
            <div className="rounded-xl border border-[#d7f1f1] bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">This page keeps your job search, match quality, and profile updates in one place.</p>
            </div>
            <div className="rounded-xl border border-[#d7f1f1] bg-white p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Next action</p>
              <p className="mt-2 text-sm text-slate-600">Complete your profile to boost matching accuracy.</p>
            </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {[
          { title: 'Match score', note: 'See fit for target roles.' },
          { title: 'Application status', note: 'Follow each step.' },
          { title: 'Profile tips', note: 'Improve visibility.' },
        ].map((item) => (
      ...
      <div className="rounded-2xl border border-[#b9e7e7] bg-white p-6 text-sm text-slate-700 shadow-sm">
        Complete your profile to boost matching accuracy.
      </div>
    </div>
  );
}
