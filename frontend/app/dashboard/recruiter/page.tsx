    ...
    <div className="flex flex-col gap-10">
      <section className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="space-y-6">
          ...
          <h1 className="max-w-2xl text-4xl font-semibold leading-tight sm:text-5xl">Recruiter dashboard</h1>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/profile/recruiter" className="rounded-md border border-[#b9e7e7] bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-[#eefcfc]">
              View profile
            </Link>
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Open roles</p>
              <p className="mt-2 text-sm text-slate-600">Track active requisitions.</p>
            </div>
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Top matches</p>
              <p className="mt-2 text-sm text-slate-600">Review candidate alignment.</p>
            </div>
            <div className="rounded-2xl border border-[#b9e7e7] bg-white p-4 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Team profile</p>
              <p className="mt-2 text-sm text-slate-600">Showcase your hiring brand.</p>
            </div>
          </div>
        </div>
        <div className="rounded-2xl border border-[#b9e7e7] bg-white p-8 shadow-sm">
          <div className="space-y-4">
            <div className="rounded-xl border border-[#d7f1f1] bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">This page helps recruiters understand which candidates fit each opening best.</p>
            </div>
            <div className="rounded-xl border border-[#d7f1f1] bg-white p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#1f6d6d]">Next action</p>
              <p className="mt-2 text-sm text-slate-600">Review roles, matches, and hiring team details.</p>
            </div>
