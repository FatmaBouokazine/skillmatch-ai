  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        ...
        <p className="text-xs text-zinc-500 mt-1">Update your company and contact details.</p>
      </div>
      ...
      <div className="bg-white border border-zinc-200 rounded-xl p-6 shadow-xs">
        <form onSubmit={handleSubmit} className="space-y-5 text-sm">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-zinc-600">Company Name</label>
            <input
              type="text"
              name="companyName"
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-zinc-600">Company Website</label>
            <input
              type="url"
              name="companyWebsite"
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-zinc-600">Company Bio</label>
            <textarea
              name="companyBio"
              rows={4}
